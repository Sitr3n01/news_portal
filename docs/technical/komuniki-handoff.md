...
- **Nenhum movimento**, inclusive hover, transições e rolagem suave, **com quatro exceções aprovadas: as partículas do hero da Home e o reveal de texto por linha (13/09/2026), o sublinhado animado ao interagir e o leve crescimento dos cards de trilhas da Home ao interagir (14/09/2026).** Com `prefers-reduced-motion: reduce` as partículas ficam paradas, o texto não é dividido nem animado, e o sublinhado e o crescimento dos cards acontecem sem animação. Preservar a regra no resto do site.
