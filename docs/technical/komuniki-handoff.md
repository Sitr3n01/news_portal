...
- **Nenhum movimento**, inclusive hover, transições e rolagem suave, **com três exceções aprovadas: as partículas do hero da Home e o reveal de texto por linha (13/09/2026) e o sublinhado animado ao interagir (14/09/2026).** Com `prefers-reduced-motion: reduce` as partículas ficam paradas, o texto não é dividido nem animado e o sublinhado aparece sem animação. Preservar a regra no resto do site.
