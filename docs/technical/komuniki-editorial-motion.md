...
**Histórico:** em 13/09/2026, a pedido do usuário, todo movimento foi removido, inclusive hover, preservando o conteúdo oficial. A versão atual está documentada em [Komuniki estática com destaque azul](komuniki-static-blue.md). As regras e testes abaixo descrevem o checkpoint anterior.
