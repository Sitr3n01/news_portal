    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('legacy_media_file_id', models.PositiveIntegerField(blank=True, db_index=True, help_text='Referência interna para migração da biblioteca de mídia legada (media_library.MediaFile). Usado apenas durante a migração de dados.', null=True)),
                ...
                ('uploaded_by_user', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cms_doc_uploaded_by+', to=settings.AUTH_USER_MODEL, verbose_name='uploaded by user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.CharField(blank=True, help_text='Fotógrafo ou fonte da imagem.', max_length=255, verbose_name='Crédito')),
                ('legacy_media_file_id', models.PositiveIntegerField(blank=True, db_index=True, help_text='Referência interna para migração da biblioteca de mídia legada (media_library.MediaFile). Usado apenas durante a migração de dados.', null=True)),
                ('collection', models.ForeignKey(default=wagtail.models.media.get_root_collection_id, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='wagtailcore.collection', verbose_name='collection')),
                ('tags', taggit.managers.TaggableManager(blank=True, help_text=None, through='taggit.TaggedItem', to='taggit.Tag', verbose_name='tags')),
                ('uploaded_by_user', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cms_img_uploaded_by+', to=settings.AUTH_USER_MODEL, verbose_name='uploaded by user')),
            ],
            options={
                'verbose_name': 'Imagem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='cms_media.image')),
            ],
            options={
