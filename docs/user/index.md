# Guia de Uso — Komuniki & Blog da Kelly

Bem-vindo à documentação de uso do sistema. Este painel de controle centralizado gerencia dois portais públicos a partir de um único lugar:

| Portal | Endereço público | O que é |
|--------|-----------------|---------|
...
Toda alteração feita no painel fica **visível imediatamente** no site público assim que você clicar em **Salvar**. Não existe botão de "publicar servidor" nem aprovação intermediária.
